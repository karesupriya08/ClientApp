<%-- 
    Document   : POApprovedModule
    Created on : Sep 6, 2017, 2:26:01 PM
    Author     : Supriya Kare
--%>
            ...
            myApp.controller("myCtrl", ['$scope', '$http', function ($scope, $http)
                {
                    ...
                    $scope.getPOdata = function (seas_code, style_no, buyer_code)
                    {
                        $http.get('getPOdata', {params: {seas_code: seas_code, style_no: style_no, buyer_code: buyer_code}}).
                                success(function (response) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5" >
                            <div class="form-group">
                                ...
                                <div  class="col-sm-6" >
                                    <select id="style_no" data-ng-model="style_no"   class="form-control" ng-change="getPOdata(seas_code, style_no, buyer_code)">
