            ...
            myApp.controller("myCtrl", ['$scope', '$http', function ($scope, $http)
                {
                    ...
                    $scope.getSizeQtyData = function (seas_code, serial, colour_code) {
                        ...
                        $http.get('getSizeQtyData', {params: {seas_code: seas_code, serial: serial, colour_code: colour_code}}).
                                success(function (response) {

                                    $scope.sizeqtydata = response;


                                    if ($scope.sizeqtydata.flag === 'false')
                                    {
                                        alert($scope.sizeqtydata.msg);
                                        $scope.isDisabled = true;
                                    }
                                    else
                                    {
                    ...
                    $scope.addNewSizes = function () {
                        $scope.isDisabled = false;
                        $scope.choices = [{}];
                        var colqty = document.getElementById("noofSizes").value;
    ...
    <body  data-ng-controller="myCtrl">
        ...
        <div>
            <div class="panel panel-info" style='width:70%;margin-left: 10%'>
                <div class="panel-heading">PO Entry Form</div>
                <div class="panel-body">
                    <form  class="form-horizontal" name="myform" data-ng-submit="submit()" nonvalidate>  
                        ...
                        <div class="row">
                            <div class="col-sm-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5"> 
                                        <select ng-model="colour_code" id="colour_code" name="colour_code" required class="form-control" ng-change="getSizeQtyData(seas_code, serial, colour_code)">
                            ...
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input class="form-control" id="buyer_code" type="text" readonly ng-model="buyer_code" ng-value="sizeqtydata.buyer_code">
                            ...
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-5">
                                        <input class="form-control" id="style_no" type="text" readonly ng-model="style_no" ng-value="sizeqtydata.style_no">
                        ...
                        <div class="row">
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"> 
                                        <input type="text" name="colour_way" id="colour_way" readonly ng-model="colour_way" ng-value="sizeqtydata.colour_way" class="form-control" />
                            ...
                            <div class="col-md-5" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5"> 
                                        <input type="text"  id="order_qty" ng-model="order_qty" readonly name="order_qty" ng-value="sizeqtydata.order_qty"  class="form-control"/>
                        ...
                        <div class="row">
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"> 
                                        <input type="text"  id="b_style" data-ng-model="b_style" readonly ng-value="sizeqtydata.b_style" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"> 
                                        <input type="date"  id="delv_date" name="delv_date"  readonly ng-model="delv_date" ng-value="sizeqtydata.delv_date"   class="form-control"/>
                        ...
                        <div class="row">
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"> 
                                        <input type="text"  id="gar_desc" ng-model="gar_desc" readonly data-ng-value="sizeqtydata.gar_desc" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"> 
                                        <input type="text"  id="main_fab" ng-model="main_fab" readonly ng-value="sizeqtydata.main_fab"  class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"> 
                                        <input type="text"  id="wov_hos" name="wov_hos" readonly ng-model="wov_hos" ng-value="sizeqtydata.wov_hos"  class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"> 
                                        <input type="text"  id="print" ng-model="print" readonly ng-value="sizeqtydata.print"  class="form-control"/>
                        ...
                        <div class="row">
                            <div class="col-md-6" >
                                <div class="form-group">
                                    <label class="control-label col-sm-5">No. Of Sizes</label>
                                    <div class="col-sm-3"> 
                                        <input type="text"  id="noofSizes" ng-model="noofSizes" ng-blur="addNewSizes()" required class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">          
                            <table class="table table-bordered">
                                ...
                                <tbody ng-repeat="s in choices" ng-init="total = 0" >
                                    <tr>
                                        <td><input type="text" name="type" ng-model="s.size_type" required /></td>  <span ng-show="myform.type.$touched && myform.type.$error.required" style="color: red">Required.</span></td>
                                <td><input type="number" name="qty" id="sizeqty" ng-model="s.size_qty" ng-blur="add(s.size_qty)" required/></td><span ng-show="myform.qty.$touched && myform.qty.$error.required" style="color: red">Required.</span></td>
                                </tr>
                                </tbody>
                            </table>
